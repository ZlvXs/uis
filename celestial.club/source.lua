local Library = {}; do
    ...
    do
        ...
        if not isfile(Library.FolderName .. '/Utilities/Hue.png') then
            writefile(Library.FolderName .. '/Utilities/Hue.png', game:HttpGet("https://raw.githubusercontent.com/ZlvXs/uis/main/celestial.club/images/hue.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Saturation.png') then
            writefile(Library.FolderName .. '/Utilities/Saturation.png', game:HttpGet("https://raw.githubusercontent.com/ZlvXs/uis/main/celestial.club/images/saturation.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Value.png') then
            writefile(Library.FolderName .. '/Utilities/Value.png', game:HttpGet("https://raw.githubusercontent.com/ZlvXs/uis/main/celestial.club/images/value.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Shadow.png') then
            writefile(Library.FolderName .. '/Utilities/Shadow.png', game:HttpGet("https://raw.githubusercontent.com/ZlvXs/uis/main/celestial.club/images/shadow.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Logo.png') then
            writefile(Library.FolderName .. '/Utilities/Logo.png', game:HttpGet("https://raw.githubusercontent.com/ZlvXs/uis/main/celestial.club/images/celestiallogo-removebg-preview.png"));
        end;
    end;
    ...
    function Library:Window(Data)
        ...
        Objects["main"].Size = UDim2.new(0, 580, 0, 637)
    ...
    function Library.Sections:Toggle(Data)
        ...
        function Toggle:Colorpicker(Data)
            ...
            SubObjects["shadow"].Image = "rbxassetid://112971167999062"
